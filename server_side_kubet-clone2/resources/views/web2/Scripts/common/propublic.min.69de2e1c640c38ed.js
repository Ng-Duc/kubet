!(function (e, t, i) {
  ...
  Array.prototype.indexOf ||
    (Array.prototype.indexOf = function (e, t) {
      ...
      for (i = Math.max(r >= 0 ? r : n - Math.abs(r), 0); n > i; ) {
    ...
    (e.prototype = {
      ...
      jsFontsKey: function (e, t) {
        ...
        return setTimeout(function () {
          ...
          i.options.extendedJsFonts && (n = n.concat(r));
          var o = "mmmmmmmmmmlli",
            s = "72px",
            ...
            f = function () {
              for (var e = [], t = 0, i = a.length; i > t; t++) {
                var n = g();
                (n.style.fontFamily = a[t]), h.appendChild(n), e.push(n);
              }
              return e;
            },
            m = function () {
            ...
            S = function (e) {
              for (var t = !1, i = 0; i < a.length; i++)
                if (
                  (t =
                    e[i].offsetWidth !== d[a[i]] ||
                    e[i].offsetHeight !== c[a[i]])
                )
                  return t;
              return t;
            },
          ...
          for (var x = 0, v = a.length; v > x; x++)
            (d[a[x]] = T[x].offsetWidth), (c[a[x]] = T[x].offsetHeight);
          var M = m();
          l.appendChild(u);
          for (var E = [], A = 0, y = n.length; y > A; A++)
            S(M[n[A]]) && E.push(n[A]);
          l.removeChild(u),
            l.removeChild(h),
            e.push({ key: "js_fonts", value: E }),
            t(e);
        }, 1);
      },
      ...
      getWebglFp: function () {
        ...
        e.shaderSource(h, n), e.compileShader(h);
