!(function (n, t) {
  ...
  function vu(n, t, r, u, f) {
    ...
    for (c.textContent = "", l = 0; (e = y[l++]); )
      if (u && -1 < i.inArray(e, u)) f && f.push(e);
        ...
        ((w = ft(e)), (o = s(c.appendChild(e), "script")), w && gi(o), r)
      )
  ...
  function ht(n, t, f, o) {
    ...
    if (
      y &&
      ((w = (a = vu(t, n[0].ownerDocument, !1, n, o)).firstChild),
  ...
  function bu(n, t, r) {
    for (var u, e = t ? i.filter(t, n) : n, f = 0; null != (u = e[f]); f++)
      r || 1 !== u.nodeType || i.cleanData(s(u)),
        u.parentNode &&
          (r && ft(u) && gi(s(u, "script")), u.parentNode.removeChild(u));
    return n;
  }
  function ni(n, t, r) {
    var o,
    ...
    return (
      ...
      (n in gu
        ...
        : (nf[n] =
            (function (n) {
              for (
                var i = n[0].toUpperCase() + n.slice(1), t = du.length;
                t--;
  ...
  function ff(n, t, r) {
    ...
    return (
      ((!e.boxSizingReliable() && o) ||
        ...
        (s = h in n) && (u = n[h])),
      (u = parseFloat(u) || 0) +
        rr(n, t, r || (o ? "border" : "content"), s, f, u) +
        "px"
    );
  }
  ...
  function ur() {
    li &&
      (!1 === f.hidden && n.requestAnimationFrame
        ? n.requestAnimationFrame(ur)
        : n.setTimeout(ur, i.fx.interval),
      i.fx.tick());
  }
  function hf() {
    return (
        ...
        return (
          l !== i &&
            ...
            c !== i &&
              ...
              u.top !== u &&
              (u.addEventListener
                ? u.addEventListener("unload", wi, !1)
                : u.attachEvent && u.attachEvent("onunload", wi)),
  ...
  i.each(
    {
      ...
      contents: function (n) {
        return "undefined" != typeof n.contentDocument
          ? n.contentDocument
  ...
  kt = function (n, t) {
    return (
      ...
      ("" === n.style.display && ft(n) && "none" === i.css(n, "display"))
    );
  };
  ki = function (n, t, i, r) {
    var f,
    ...
    special: {
      ...
      click: {
        setup: function (n) {
          var t = this || n;
          return (
            dt.test(t.type) && t.click && c(t, "input") && hi(t, "click", ot),
            !1
          );
        },
        trigger: function (n) {
          var t = this || n;
          return (
            dt.test(t.type) && t.click && c(t, "input") && hi(t, "click"), !0
          );
        },
        _default: function (n) {
          var t = n.target;
      ...
      if (
        ...
        for (f = s(h), u = 0, c = (o = s(n)).length; u < c; u++)
          (l = o[u]),
            (a = f[u]),
            void 0,
            "input" === (v = a.nodeName.toLowerCase()) && dt.test(l.type)
              ? (a.checked = l.checked)
              : ("input" !== v && "textarea" !== v) ||
    ...
    style: function (n, t, r, u) {
      if (n && 3 !== n.nodeType && 8 !== n.nodeType && n.style) {
        var f,
          ...
          s = n.style;
        if (
          (l || (t = ir(c)), (o = i.cssHooks[t] || i.cssHooks[c]), void 0 === r)
        )
  ...
  i.each(["height", "width"], function (n, t) {
    i.cssHooks[t] = {
      get: function (n, r, u) {
        if (r)
          return !ro.test(i.css(n, "display")) ||
    ...
    _default: {
      ...
      set: function (n) {
        i.fx.step[n.prop]
          ? i.fx.step[n.prop](n)
          : 1 !== n.elem.nodeType ||
            (!i.cssHooks[n.prop] && null == n.elem.style[ir(n.prop)])
          ? (n.elem[n.prop] = n.now)
        ...
        if ((h = !i.isEmptyObject(t)) || !i.isEmptyObject(p))
          ...
          p))
            h ||
              ...
              a && et([n], !0),
              v.done(function () {
                for (f in (a || et([n]), r.remove(n, "fxshow"), p))
                  i.style(n, f, p[f]);
              })),
              (h = cf(a ? e[f] : 0, f, v)),
              f in e ||
        ...
        return "undefined" == typeof n.getAttribute
          ...
          : ((1 === e && i.isXMLDoc(n)) ||
              (u =
                ...
                (i.expr.match.bool.test(t) ? lf : void 0)),
            void 0 !== r
              ? null === r
    ...
    trigger: function (t, e, o, s) {
      ...
      if (
        ...
        if (!s && !a.noBubble && !tt(o)) {
          for (
            d = a.delegateType || h, er.test(d + h) || (c = c.parentNode);
            c;
            c = c.parentNode
          )
            w.push(c), (l = c);
  ...
  return (
      ...
      ajax: function (t, r) {
        ...
        if (
          ...
          try {
            ...
            c.href = c.href;
            u.crossDomain =
              lr.protocol + "//" + lr.host != c.protocol + "//" + c.host;
          } catch (t) {
            u.crossDomain = !0;
          }
        }
        ...
        u.hasContent
          ? u.data &&
            ...
            (u.data = u.data.replace(so, "+"))
          : ((p = u.url.slice(o.length)),
            u.data &&
              (u.processData || "string" == typeof u.data) &&
              ((o += (sr.test(o) ? "&" : "?") + u.data), delete u.data),
            !1 === u.cache &&
              ((o = o.replace(co, "$1")),
              (p = (sr.test(o) ? "&" : "?") + "_=" + pf++ + p)),
            (u.url = o + p)),
    ...
    (e.createHTMLDocument =
      (((te = f.implementation.createHTMLDocument("").body).innerHTML =
        "<form></form><form></form>"),
    ...
    i.each(["top", "left"], function (n, t) {
      i.cssHooks[t] = ku(e.pixelPosition, function (n, r) {
        if (r)
          return (r = ni(n, t)), tr.test(r) ? i(n).position()[t] + "px" : r;
      });
    }),
